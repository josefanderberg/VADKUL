...
import { Send, Image as ImageIcon, Search, ArrowLeft, MoreVertical, Phone, Video, Info, User } from 'lucide-react';
import toast from 'react-hot-toast';
import type { UserProfile, AppNotification, ChatMessage as ChatMessageType, ChatRoom as ChatType } from '../types';
...
export default function Chat() {
    ...
    const hasUnreadMessages = (chat: ChatType) => {
                        ...
                        <>
                            ...
                            <div className="p-4 bg-card border-b border-border flex items-center gap-3 shadow-sm z-10">
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <button
                                            onClick={() => otherId && router.push(`/public-profile/${otherId}`)}
                                            className="flex items-center gap-3 cursor-pointer hover:opacity-70 transition-opacity text-left"
