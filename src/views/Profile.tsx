                    ...
                    <div className="p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start text-center md:text-left gap-6 relative">
                        ...
                        <div className="absolute top-0 left-0 w-full p-4 flex justify-between md:hidden pointer-events-none">
                            ...
                            <div className="flex gap-2 pointer-events-auto">
                                {isMyProfile ? (
                                    <>
                                        <button onClick={() => router.push('/settings')} className="p-2 text-muted-foreground hover:text-primary hover:bg-muted rounded-full transition-colors bg-background/50 backdrop-blur-sm shadow-sm">
                                            <Settings size={20} />
                                        </button>
                        ...
                        <div className="hidden md:flex gap-2 self-start ml-auto">
                            {isMyProfile ? (
                                <>
                                    ...
                                    <button onClick={() => router.push('/settings')} className="p-2 text-muted-foreground hover:text-primary hover:bg-muted rounded-full transition-colors">
                                        <Settings size={20} />
                                    </button>
                        ...
                        {activeTab === 'joined' && !isMyProfile && friendStatus !== 'accepted' ? (
                            ...
                            <div className="text-center py-16 bg-card rounded-2xl border border-dashed border-border animate-in fade-in zoom-in-95 duration-300">
                                ...
                                {isMyProfile && activeTab === 'hosted' && (
                                    <button onClick={() => router.push('/create')} className="px-5 py-2 bg-primary text-primary-foreground rounded-lg font-bold shadow-md hover:bg-primary/90 transition-transform active:scale-95">
                                        Skapa ett event
                                    </button>
                                )}
                            </div>
