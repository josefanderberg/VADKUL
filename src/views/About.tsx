...
import { TrendingUp, ShieldCheck, Globe, Lightbulb, Search, Handshake, Users, HelpCircle, Trophy, MessageSquarePlus, Info as InfoIcon, ArrowLeft } from 'lucide-react';
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
                        ...
                        <section className="py-24 px-6 bg-slate-50 dark:bg-slate-900/50">
                            <div className="max-w-4xl mx-auto">
                                <div className="text-center mb-16">
                                    <Link href="/" className="flex items-center gap-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                        <ArrowLeft size={18} />
                                        Tillbaka till kartan
                                    </Link>                <h2 className="text-3xl md:text-4xl font-bold mb-4">Vår Filosofi: Sunt Förnuft</h2>
