...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.solleftea.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=solleftea`

> Probe-sitemap 2026-06-04: 8 event-URLs (evenemang-mönster).
