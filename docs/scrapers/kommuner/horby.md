...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.horby.se/wp-json/wp/v2/event
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 21
- **Kör om probet:** `npm run probe-wp -- --only=horby`

> Probe 2026-06: 21 events. fetchDetailPage.
