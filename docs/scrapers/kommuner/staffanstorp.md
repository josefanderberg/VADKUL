...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.staffanstorp.se/wp-json/wp/v2/event
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 0
- **Kör om probet:** `npm run probe-wp -- --only=staffanstorp`

> Probe 2026-06: 0 events vid probe (men endpoint finns). Kollar veckovis ifall de fyller på.
...
- **expectedMinEvents:** 1 (under detta = potentiellt trasig källa)
