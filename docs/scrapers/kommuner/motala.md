...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.motala.se/sitemap_index.xml
- **Upptäckt:** 2026-06-03
- **Kör om probet:** `npm run probe-sitemap -- --filter=motala`

> Probe-sitemap 2026-06-03: 131 aktivitet-URLs. Text-parser hittar datum i body.
