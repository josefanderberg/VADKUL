...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.solvesborg.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=solvesborg`

> Probe-sitemap 2026-06-04: 212 event-URLs (evenemang-mönster).
