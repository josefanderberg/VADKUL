...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.landskrona.se/sitemap.xml
- **Upptäckt:** 2026-06-03
- **Kör om probet:** `npm run probe-sitemap -- --filter=landskrona`

> Probe-sitemap 2026-06-03: 180 evenemang-URLs. <time datetime>.
