...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.katrineholm.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=katrineholm`

> Probe-sitemap 2026-06-04: 286 event-URLs (evenemang-mönster).
