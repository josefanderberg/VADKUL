...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.herjedalen.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=harjedalen`

> Probe-sitemap 2026-06-04: 6 event-URLs (evenemang-mönster).
