...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.karlskoga.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=karlskoga`

> Probe-sitemap 2026-06-04: 12 event-URLs (aktivitet-mönster).
