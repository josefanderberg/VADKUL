...
- **Probe-URL:** https://www.uppvidinge.se/uppleva-och-gora/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=uppvidinge`
...
{
  "urls": [
    "https://www.uppvidinge.se/uppleva-och-gora/evenemang"
  ],
  "defaultCity": "Uppvidinge"
}
```
