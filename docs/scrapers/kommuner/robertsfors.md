...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.robertsfors.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=robertsfors`

> Probe-sitemap 2026-06-04: 285 event-URLs (evenemang-mönster).
