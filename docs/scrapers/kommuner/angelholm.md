...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.engelholm.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=angelholm`

> Probe-sitemap 2026-06-04: 92 event-URLs (evenemang-mönster).
