...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.eslov.se/wp-json/wp/v2/event
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 141
- **Kör om probet:** `npm run probe-wp -- --only=eslov`

> Probe 2026-06: 141 events. fetchDetailPage extraherar datum från HTML.
...
- **expectedMinEvents:** 70 (under detta = potentiellt trasig källa)
