...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.lidingo.se/wp-json/wp/v2/evenemang
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 18
- **Kör om probet:** `npm run probe-wp -- --only=lidingo`

> Probe 2026-06: 18 events. Svensk CPT + content-parser.
...
- **expectedMinEvents:** 9 (under detta = potentiellt trasig källa)
