...
- **Probe-URL:** https://www.bengtsfors.se/uppleva-och-gora/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=bengtsfors`
...
{
  "urls": [
    "https://www.bengtsfors.se/uppleva-och-gora/evenemang"
  ],
  "defaultCity": "Bengtsfors"
}
```
