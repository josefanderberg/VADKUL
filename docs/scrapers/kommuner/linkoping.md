...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.visitlinkoping.se/sitemap.xml
- **Upptäckt:** 2026-06-03
- **Kör om probet:** `npm run probe-sitemap -- --filter=linkoping`

> Probe-sitemap 2026-06-03: 187 evenemang-URLs. <time datetime> finns.
