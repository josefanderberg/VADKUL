...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.nykoping.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=nykoping`

> Probe-sitemap 2026-06-04: 2404 event-URLs (kalender-mönster).
