...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.alingsas.se/wp-json/wp/v2/event
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 108
- **Kör om probet:** `npm run probe-wp -- --only=alingsas`

> Probe 2026-06: 108 events. fetchDetailPage.
...
- **expectedMinEvents:** 54 (under detta = potentiellt trasig källa)
