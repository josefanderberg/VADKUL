...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.monsteras.se/sitemap.xml
- **Upptäckt:** 2026-06-03
- **Kör om probet:** `npm run probe-sitemap -- --filter=monsteras`

> Probe-sitemap 2026-06-03: 649 event-URLs. Text-parser ur #event-dates-list.
