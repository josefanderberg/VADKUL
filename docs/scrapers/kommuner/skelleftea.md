...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.skelleftea.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=skelleftea`

> Probe-sitemap 2026-06-04: 95 event-URLs (aktivitet-mönster).
