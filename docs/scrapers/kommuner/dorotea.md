...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.dorotea.se/sitemap.xml
- **Upptäckt:** 2026-06-03
- **Kör om probet:** `npm run probe-sitemap -- --filter=dorotea`

> Probe-sitemap 2026-06-03: 10 kalender-URLs. Text-parser. Liten kommun, sparsam volym.
