...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.morbylanga.se/sitemap.xml
- **Upptäckt:** 2026-06-03
- **Kör om probet:** `npm run probe-sitemap -- --filter=morbylanga`

> Probe-sitemap 2026-06-03: 12 aktivitet-URLs. microdata startDate.
