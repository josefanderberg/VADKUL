...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.hoor.se/wp-json/wp/v2/event
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 23
- **Kör om probet:** `npm run probe-wp -- --only=hoor`

> Probe 2026-06: 23 events. fetchDetailPage.
...
- **expectedMinEvents:** 11 (under detta = potentiellt trasig källa)
