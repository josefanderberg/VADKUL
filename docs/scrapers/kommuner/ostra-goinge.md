...
- **Probe-URL:** https://www.ostragoinge.se/uppleva-och-gora/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=ostra-goinge`
...
{
  "urls": [
    "https://www.ostragoinge.se/uppleva-och-gora/evenemang"
  ],
