...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.alvdalen.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=alvdalen`

> Probe-sitemap 2026-06-04: 231 event-URLs (evenemang-mönster).
