...
- **Probe-URL:** https://www.hammaro.se/uppleva-och-gora/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=hammaro`
...
{
  "urls": [
    "https://www.hammaro.se/uppleva-och-gora/evenemang"
  ],
  "defaultCity": "Hammarö"
}
```
