...
- **Probe-URL:** https://www.malung-salen.se/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=malung-salen`
...
{
  "urls": [
    "https://www.malung-salen.se/evenemang"
  ],
  "defaultCity": "Malung-Sälen"
}
```
