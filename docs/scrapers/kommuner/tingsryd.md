...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.tingsryd.se/wp-json/wp/v2/event
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 15
- **Kör om probet:** `npm run probe-wp -- --only=tingsryd`

> Probe 2026-06: 15 events. fetchDetailPage.
...
- **expectedMinEvents:** 7 (under detta = potentiellt trasig källa)
