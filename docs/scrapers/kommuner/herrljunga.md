...
- **Probe-URL:** https://www.herrljunga.se/uppleva-och-gora/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=herrljunga`
...
{
  "urls": [
    "https://www.herrljunga.se/uppleva-och-gora/evenemang"
  ],
  "defaultCity": "Herrljunga"
}
```
