...
- **Probe-URL:** https://www.vetlanda.se/uppleva-och-gora/evenemangskalender
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=vetlanda`
...
{
  "urls": [
    "https://www.vetlanda.se/uppleva-och-gora/evenemangskalender"
  ],
