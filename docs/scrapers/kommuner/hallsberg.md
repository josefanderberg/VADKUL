...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.hallsberg.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=hallsberg`

> Probe-sitemap 2026-06-04: 19 event-URLs (evenemang-mönster).
