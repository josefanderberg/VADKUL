...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.goteborg.com/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=goteborg`

> Probe-sitemap 2026-06-04: 594 event-URLs (evenemang-mönster).
