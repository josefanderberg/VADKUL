...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.orkelljunga.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=orkelljunga`

> Probe-sitemap 2026-06-04: 2 event-URLs (evenemang-mönster).
