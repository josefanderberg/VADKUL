...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.visitdalarna.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=mora`

> Probe-sitemap 2026-06-04: 904 event-URLs (aktivitet-mönster).
