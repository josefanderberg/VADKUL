...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.vanersborg.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=vanersborg`

> Probe-sitemap 2026-06-04: 4 event-URLs (evenemang-mönster).
