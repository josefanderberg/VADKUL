...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.soderhamn.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=soderhamn`

> Probe-sitemap 2026-06-04: 5 event-URLs (aktivitet-mönster).
