...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.destinationuppsala.se/wp-json/wp/v2/event
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 1217
- **Kör om probet:** `npm run probe-wp -- --only=uppsala`

> Probe 2026-06: 1217 events totalt. fetchDetailPage cap=300 för rimlig körtid.
...
- **expectedMinEvents:** 608 (under detta = potentiellt trasig källa)
