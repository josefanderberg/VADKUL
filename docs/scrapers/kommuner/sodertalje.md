...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.sodertalje.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=sodertalje`

> Probe-sitemap 2026-06-04: 316 event-URLs (aktivitet-mönster).
