...
- **Probe-URL:** https://www.ljusnarsberg.se/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=ljusnarsberg`
...
{
  "urls": [
    "https://www.ljusnarsberg.se/evenemang"
  ],
  "defaultCity": "Ljusnarsberg"
}
```
