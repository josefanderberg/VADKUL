...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.hedemora.se/sitemap_index.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=hedemora`

> Probe-sitemap 2026-06-04: 170 event-URLs (evenemang-mönster).
