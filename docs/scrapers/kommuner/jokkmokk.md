...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.jokkmokk.se/sitemap.xml
- **Upptäckt:** 2026-06-03
- **Kör om probet:** `npm run probe-sitemap -- --filter=jokkmokk`

> Probe-sitemap 2026-06-03: 463 evenemang-URLs. Text-parser. OBS: många historiska — runner-fönster filtrerar.
