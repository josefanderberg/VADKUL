...
- **Probe-URL:** https://www.nykvarn.se/uppleva-och-gora/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=nykvarn`
...
{
  "urls": [
    "https://www.nykvarn.se/uppleva-och-gora/evenemang"
  ],
  "defaultCity": "Nykvarn"
}
```
