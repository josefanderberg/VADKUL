...
- **Probe-URL:** https://www.ljungby.se/uppleva-och-gora/evenemangskalender
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=ljungby`
...
{
  "urls": [
    "https://www.ljungby.se/uppleva-och-gora/evenemangskalender"
  ],
  "defaultCity": "Ljungby"
}
```
