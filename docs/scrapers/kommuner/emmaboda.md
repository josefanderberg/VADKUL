...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.emmaboda.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=emmaboda`

> Probe-sitemap 2026-06-04: 50 event-URLs (evenemang-mönster).
