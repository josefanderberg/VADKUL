...
- **Metod:** `probe-wp`
- **Probe-URL:** https://www.tranas.se/wp-json/wp/v2/event
- **Upptäckt:** 2026-06-01
- **Antal events vid upptäckt:** 53
- **Kör om probet:** `npm run probe-wp -- --only=tranas`

> Probe 2026-06: 53 events.
...
- **expectedMinEvents:** 26 (under detta = potentiellt trasig källa)
