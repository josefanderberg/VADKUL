...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.karlskrona.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=karlskrona`

> Probe-sitemap 2026-06-04: 3 event-URLs (aktivitet-mönster).
