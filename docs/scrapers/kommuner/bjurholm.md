...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.bjurholm.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=bjurholm`

> Probe-sitemap 2026-06-04: 32 event-URLs (evenemang-mönster).
