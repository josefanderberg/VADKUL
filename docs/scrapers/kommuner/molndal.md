...
- **Probe-URL:** https://www.molndal.se/uppleva-och-gora/evenemang
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitevision -- --only=molndal`
...
{
  "urls": [
    "https://www.molndal.se/uppleva-och-gora/evenemang"
  ],
  "defaultCity": "Mölndal"
}
```
