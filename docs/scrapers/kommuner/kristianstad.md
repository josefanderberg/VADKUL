...
- **Metod:** `probe-sitemap`
- **Probe-URL:** https://www.kristianstad.se/sitemap.xml
- **Upptäckt:** 2026-06-04
- **Kör om probet:** `npm run probe-sitemap -- --filter=kristianstad`

> Probe-sitemap 2026-06-04: 14 event-URLs (aktivitet-mönster).
