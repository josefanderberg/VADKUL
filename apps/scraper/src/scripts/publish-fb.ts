...
import { postToFacebook, postToInstagram } from '../utils/socialPublish';
...
// postToFacebook / postToInstagram bor nu i ../utils/socialPublish (delas med
// publish-digest.ts). FB_PAGE_ID/FB_PAGE_TOKEN/IG_USER_ID läses därifrån via
// process.env — secret-laddningen ovan fyller dem.
