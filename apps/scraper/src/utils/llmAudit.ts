...
7. emoji — EN enda emoji som bäst representerar just detta SPECIFIKA event (fritt val, inte bunden till kategorin). Var PRECIS — använd INTE ⚽ för all sport. Matcha aktiviteten:
   SPORT/RÖRELSE: yoga/meditation/mindfulness → 🧘 · cykling/MTB/spinning → 🚴 · löpning/maraton/terränglopp → 🏃 · simning → 🏊 · vandring/friluftsliv → 🥾 · gym/styrketräning/crossfit → 🏋️ · fotboll → ⚽ · ishockey → 🏒 · innebandy → 🏑 · basket → 🏀 · tennis/padel → 🎾 · golf → ⛳ · discgolf/frisbee → 🥏 · orientering → 🧭 · bordtennis → 🏓 · badminton → 🏸 · ridning/häst → 🐴 · kampsport/boxning → 🥊 · dans/zumba → 💃 · klättring → 🧗 · skidor → ⛷️
