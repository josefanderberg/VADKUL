 ...
 *
 * KOPIA av apps/scraper/src/utils/townBoundary.ts (sidinläggs-bandets
 * kommunfilter) — webben kan inte importera över workspace-gränsen, samma
 * mönster som functions eventShareSlug-kopia. Ändras originalet måste den
 * här filen följa med (testerna är också kopierade). Används av stads-/
 * kategorisidornas delningsbilder (cityShare.kommunEvents, Josef 7/9).
 *
