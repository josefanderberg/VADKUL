                            ...
                            {cities.map(({ city, weekCount }) => (
                                <li key={city.name}>
                                    <button
                                        ...
                                        className="w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group"
                                    >
                                        <span className="w-9 h-9 rounded-full bg-[#006AA7]/10 flex items-center justify-center shrink-0">
                                            <MapPin size={17} className="text-[#006AA7]" />
                                        </span>
                                        ...
                                        <ArrowRight size={16} className="text-slate-300 group-hover:text-[#006AA7] transition-colors shrink-0" />
                                    </button>
                                </li>
                            ))}
                        </ul>
                ...
                {results.length === 0 ? (
                    hasCities ? (
                        ...
                        <div className="px-6 py-8 flex flex-col items-center gap-2 text-center">
                            ...
                            <p className="text-xs text-slate-400">Sök på stad, titel, plats eller arrangör.</p>
                        </div>
                    )
                ) : (
