...
exports.VAXJO_VENUES = void 0;
exports.getVenueCoordinates = getVenueCoordinates;
exports.geocodeVenue = geocodeVenue;
// Växjö venue coordinates lookup table
exports.VAXJO_VENUES = {
...
function getVenueCoordinates(venueName) {
    if (!venueName)
        return null;
    // Exact match
    if (exports.VAXJO_VENUES[venueName])
        return exports.VAXJO_VENUES[venueName];
    // Case-insensitive match
    const lowerVenue = venueName.toLowerCase().trim();
    for (const [key, coords] of Object.entries(exports.VAXJO_VENUES)) {
...
async function nominatimSearch(query) {
    ...
    for (const result of data !== null && data !== void 0 ? data : []) {
...
//# sourceMappingURL=venueCoordinates.js.map