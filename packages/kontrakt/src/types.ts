// @vadkul/kontrakt — delade dokument-/API-typer. Flyttade från webbens
// src/types/index.ts (fas 0); webben re-exporterar därifrån.
import type { EventCategoryType } from './categories';

/**
 * Strukturell spegel av Firestores Timestamp — paketet får INTE bero på
 * firebase (appen kör @react-native-firebase, functions kör firebase-admin,
 * och alla tre klienternas Timestamp-klasser matchar den här formen).
 * Riktiga Timestamp-instanser är direkt tilldelningsbara.
 */
